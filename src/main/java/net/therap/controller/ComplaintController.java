...
import net.therap.validator.ComplaintValidator;
...
import static net.therap.util.StringConst.IS_CUSTOMER;
...
public class ComplaintController {
    ...
    public String showList(HttpSession session,
        ...
        model.addAttribute(IS_CUSTOMER, AccesChecker.isCustomer(session));
    ...
    public String show(HttpSession session,
        ...
        complaint.setUser(userService.findById((int) session.getAttribute(SESSION_KEY_USER_ID)));
