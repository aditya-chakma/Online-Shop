...
import net.therap.editor.CategoryEditor;
...
import net.therap.validator.ProductValidator;
...
public class ProductController {
    ...
    public String showList(@RequestParam(defaultValue = "0") int categoryId,
        ...
        if (Objects.nonNull(httpSession.getAttribute(SESSION_KEY_USER_ROLE))) {
            httpSession.setAttribute(SESSION_KEY_USER_ID, httpSession.getAttribute(SESSION_KEY_USER_ID));
